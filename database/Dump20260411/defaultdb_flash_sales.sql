...
CREATE TABLE `flash_sales` (
  ...
  KEY `idx_flash_time` (`start_at`,`end_at`),
  CONSTRAINT `flash_sales_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Đợt Flash Sale';
...
INSERT INTO `flash_sales` VALUES (1,1,40.00,'2025-04-24 00:00:00','2025-04-24 23:59:59',1),(2,2,120.00,'2025-04-24 00:00:00','2025-04-24 23:59:59',1),(3,3,50.00,'2025-04-24 00:00:00','2025-04-24 23:59:59',1);
...
-- Dump completed on 2026-04-11 21:32:03
